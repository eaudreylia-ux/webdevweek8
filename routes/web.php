...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/product/edit/{product_id}', [StoreController::class, 'product_edit_form'])->name('product.edit-form');
    Route::put('/product/edit/{product_id}', [StoreController::class, 'update_product'])->name('product.update');
